...
internal static class Verify
{
    ...
    public static void IsApartmentState(ApartmentState requiredState)
    {
        ...
        {
            throw new InvalidOperationException(ApplicationStrings.Verify_ApartmentState.Format(requiredState));
        }
    }
    ...
    public static void IsNeitherNullNorEmpty(string value, string name)
    {
        ...
        if (value == null)
        {
            //throw new ArgumentNullException(name, (string)ApplicationStrings.Verify_NeitherNullNorEmpty);
            throw new ArgumentNullException(name, (string)ApplicationStrings.Verify_NeitherNullNorEmpty);
        }
        if (value == "")
        {
            throw new ArgumentException(ApplicationStrings.Verify_NeitherNullNorEmpty.Format(name));
        }
    }
    ...
    public static void FileExists(string filePath, string parameterName)
    {
        ...
        {
            throw new ArgumentException(ApplicationStrings.Verify_FileExists.Format(filePath), parameterName);
        }
    }
}