...
{
    [DllImport(ExternDll.Shell32, EntryPoint = "SHAddToRecentDocs", BestFitMapping = false, ThrowOnUnmappableChar = true)]
    private static extern void SHAddToRecentDocsString(SHARD uFlags, [MarshalAs(UnmanagedType.LPWStr)] string pv);

    // https://stackoverflow.com/questions/12577320/shaddtorecentdocs-doesnt-add-my-file-to-recent-documents
