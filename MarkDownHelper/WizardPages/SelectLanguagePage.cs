...
{
    [ToolboxItem(false)]
    public partial class SelectLanguagePage : WizardPage
    {
        ...
        private void DoOperation(string language)
        {
            string beforeText = Data["TestText"].ToString();
            string trimmedText = beforeText.TrimEnd();

            string leadText = $"```{language}";

            string endText = "```";

            string afterText = $"{leadText}\r\n{trimmedText}\r\n{endText}\r\n";
...
// Highlight.js language list - https://highlightjs.readthedocs.io/en/latest/supported-languages.html
